...
[RegisterCard(typeof(MgrTokenCardPool), StableEntryStem = "expand_note_rack")]
public sealed class ExpandNoteRack : MgrCard, INoteSlotChoice
{
    public ExpandNoteRack() : base(
        0,
        CardType.Skill,
        CardRarity.Token,
        TargetType.None,
