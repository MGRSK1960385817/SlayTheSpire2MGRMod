...
public sealed class ThirdMouth : MgrCard
{
    ...
    public ThirdMouth() : base(2, CardType.Power, CardRarity.Rare, TargetType.Self)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        await PowerCmd.Apply<FortePower>(
            ...
            Owner.Creature,
            this);
        await MgrNoteSystem.ChangeSlotCapacity(
            choiceContext,
            Owner,
            DynamicVars["Slots"].IntValue);
