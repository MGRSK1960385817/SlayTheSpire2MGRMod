...
public sealed class WeatheredPlectrum : ModRelicTemplate
{
    ...
    public override RelicAssetProfile AssetProfile => new(
        IconPath: $"{Entry.ResPath}/images/relics/WeatheredPlectrum.png",
        IconOutlinePath: $"{Entry.ResPath}/images/relics/WeatheredPlectrum_outline.png",
        BigIconPath: $"{Entry.ResPath}/images/relics/WeatheredPlectrum.png");
